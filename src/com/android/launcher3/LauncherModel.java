    ...
    private class LoaderTask implements Runnable {
        ...
        private boolean loadWorkspace() {
            ...
            for (ItemInfo i : sBgWorkspaceItems){
                Log.e("zhao11sBgWorkspaceItems",i.toString());
            }
            for(LauncherAppWidgetInfo i : sBgAppWidgets){
                Log.e("zhao11sBgAppWidgets",i.toString());
            }
            for(FolderInfo i : sBgFolders.values()){
                Log.e("zhao11sBgFolders",i.toString());
            }
            for(ItemInfo i : sBgItemsIdMap.values()){
                Log.e("zhao11sBgItemsIdMap",i.toString());
            }
            for(Long i : sBgWorkspaceScreens){
                Log.e("zhao11sBgWorkspaceScreens",i.toString());
            }
