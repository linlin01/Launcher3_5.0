...
Log.i("zhao11size","grid.folderCellWidthPx:"+grid.folderCellWidthPx+","+grid.folderCellHeightPx);
    ...
    public void animateOpen() {
        ...
        if (!Utilities.isLmpOrAbove()) {
            ...
            prepareReveal();
            centerAboutIcon();//这个方法就是计算打开folder时folder的大小
    ...
    private void setupContentDimensions(int count) {//这个貌似是计算文件夹里的item的countX和countY
        ArrayList<View> list = getItemsInReadingOrder();
...
//        Log.i("zhao11folder","mheight:"+mheight);
        ...
        mScrollView.measure(contentAreaWidthSpec, contentAreaHeightSpec);//这句话是改scrollview的位置的
