 ...
 */
public class RGKMultiTouchController<T> {
    ...
    public RGKMultiTouchController(MultiTouchObjectCanvas<T> objectCanvas) {
        this(objectCanvas, true);
    }

    /** Full constructor */
    public RGKMultiTouchController(MultiTouchObjectCanvas<T> objectCanvas, boolean handleSingleTouchEvents) {
